...
var T = D;
const $ = /* @__PURE__ */ b(T);
var i = /* @__PURE__ */ ((e) => (e.ACTIVE = "active", e.INACTIVE = "inactive", e.UNAVAILABLE = "unavailable", e.ERROR = "error", e))(i || {}),
    N = Object.defineProperty, V = Object.getOwnPropertyDescriptor, m = (e, t, a, s) => {
...
let p = class extends E {
    ...
    copyInfoToClipboard() {
        const e = this.renderRoot.querySelectorAll(".info-tray dt, .info-tray dd"),
            t = Array.from(e).map((a) => (a.localName === "dd" ? ": " : `
